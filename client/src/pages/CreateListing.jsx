   ...
   <main className='p-3 max-w-4xl mx-auto'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <input className='p-3 border border-gray-300 rounded-lg' type="number" id='bedrooms' min='1' max='10' required onChange={handleChange} checked={formData.type === 'bedrooms'} />
            <p>Beds</p>
            </div>
            <div className='flex items-center gap-2'> 
            <input className='p-3 border border-gray-300 rounded-lg' type="number" id='bathrooms' min='1' max='10' required onChange={handleChange} checked={formData.type === 'bathrooms'} />
            <p>Baths</p>
            </div>
            <div className='flex items-center gap-2'> 
            <input className='p-3 border border-gray-300 rounded-lg' type="number" id='regularPrice' min='50' max='1000000' required onChange={handleChange} checked={formData.type === 'regularPrice'}/>
            ...
            {formData.offer && (
            <div className='flex items-center gap-2'> 
            <input className='p-3 border border-gray-300 rounded-lg' type="number" id='discountPrice' min='0' max='1000000' required onChange={handleChange} checked={formData.type === 'discountPrice'}/>
            <div className='flex flex-col items-center'> 
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <span className='font-normal text-gray-600 ml-2'>The image will be the cover (max 6)</span>
            </p>
