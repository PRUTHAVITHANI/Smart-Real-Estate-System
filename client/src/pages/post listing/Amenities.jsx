...
const handleSubmit = async(e) => {
  ...
  return (
   ...
   <div className='w-full bg-[#ECF9FF] '>
      ...
      <h1 className='col-span-6 mb-10 text-4xl ml-24 text-center mr-28 text-[#435585] mt-16 drop-shadow-2x italic font-mono font-semibold  '>Property Amenities</h1>
      <div className='mb-4 flex flex-cols-6 gap-4 ml-20'>
               ...
               <div className='mb-4 flex flex-cols-6 gap-4 ml-20'>
                ...
                <span className='font-medium'>24x7 Security</span>
                </div>
               <div className='mb-4 flex flex-cols-6 gap-4 ml-20'>
 ...
 <h1 className='col-span-6 mb-10 text-4xl ml-24  text-center mr-28 text-[#435585] drop-shadow-2x italic font-mono font-semibold '>Add Photos</h1>

           

        <p className='col-span-6 font-medium ml-20'>
        ...
        <div className='flex flex-cols-6 col-span-6 flex-1 gap-4 ml-20'>
          
            <p className='font-medium'>Images: 
            <span className='font-semibold text-gray-600 ml-2'>The image will be the cover (max 6)</span>
            </p>
            </div>
          ...
          disabled={loading || uploading}
            type="submit"
            className={`border-2 font-serif text-lg ml-24 mb-28 bg-[#748DA6] w-1/4 text-[#0E2954] font-bold py-2 px-4 rounded hover:border-[#748DA6] hover:bg-[#ECF9FF] hover:text-[#748DA6] `}  
