...
function PropertyDetail() {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
       ...
       navigate(`/post-listing/update-property/${data._id}`);
  ...
  return (
    <>
      ...
      <h1 className="col-span-2 mb-10 text-4xl ml-24  text-center mr-28 text-[#435585] mt-20 drop-shadow-2x italic font-mono font-semibold  ">Property Info & address</h1>

      <div className="mb-4 flex flex-cols-2 ml-40">
  <label
    htmlFor="Property for"
    className="text-[#535C91] font-semibold label block  text-lg mr-8 mb-2 mt-1 w-48"
  >
    Property for
  </label>
  <div className="flex items-center">
    ...
    />
    <label htmlFor="sell" className="mr-4">
      Sell
    </label>
    <input
      type="radio"
    ...
    <label htmlFor="rent">Rent</label>
      ...
      <h1 className="col-span-2 mb-10 text-4xl ml-24  text-center mr-28 text-[#435585] drop-shadow-2x italic font-mono font-semibold  ">
      ...
      <h1 className="col-span-2 mb-10 text-4xl ml-24  text-center mr-28 text-[#435585] drop-shadow-2x italic font-mono font-semibold  ">Property Features & Price</h1>
      ...
      <div className="mb-4 flex flex-cols-2 ml-40 flex-wrap gap-6">
        <div className="flex items-center gap-2">
          <input
            ...
            required
          />
          <p className='text-[#535C91] font-semibold'>Beds</p>
        </div>
        <div className="flex items-center gap-2">
          <input
            className="border border-[#352F44] w-1/2 p-2 rounded-lg shadow-md focus:outline-none focus:border-[#435585]"
            ...
            required
          />
          <p className='text-[#535C91] font-semibold'>Baths</p>
        </div>
        <div className="flex items-center gap-2">
          <input
            className="border border-[#352F44] w-1/2 p-2 rounded-lg shadow-md focus:outline-none focus:border-[#435585]"
            ...
            required
          />
          <p className='text-[#535C91] font-semibold'>Balconies</p>
        </div>
      ...
      <h1 className="col-span-2 mb-10 text-4xl ml-24  text-center mr-28 text-[#435585] drop-shadow-2x italic font-mono font-semibold  ">Property Descriptions</h1>
